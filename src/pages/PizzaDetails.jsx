    ...
    <Helmet title="Product-details">
      {isUpdateNotificationDisplayed && (
        <div className="updateCartNotifiation">
          <span>Вы успешно обновили корзину!</span>
        </div>
      )
      }
      ...
      <section>
        <Container>
          <Row>
            ...
            <Col lg="6" md="6">
              <div className="single__product-content">
                ...
                <button onClick={addItem} className="addTOCART__btn">
                  {cartProducts.find(item => item.id === id) ? 'Добавить в корзину' : 'Добавить в корзину'}
                </button>
              </div>
            </Col>
            ...
            <Col lg="12">
              <h6 className="description">Описание:</h6>
